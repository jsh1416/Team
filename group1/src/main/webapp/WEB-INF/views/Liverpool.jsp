...
<style>
	.firstSection::before{
		content: "";
        background: url(${cpath}/resources/images/background/Liverpool/4.png);
						...
						<table>
							<thead>
								<tr class="row100 head" >
									...
									<th class="cell100 column2" style="background:${clubColor};"><a href="${cpath }/0?param=viewOrder#thirdPage" style="color: #FFFFFF;"><h6>View</h6></a></th>
									<th class="cell100 column3" style="background:${clubColor};"><a href="${cpath }/0?param=likeOrder#thirdPage" style="color: #FFFFFF;"><h6>Like</h6></a></th>
									<th class="cell100 column3" style="background:${clubColor};"><button style="color: #FFFFFF;" id="writer"><h6>Writer</h6></button></th>
									<th class="cell100 column3" style="background:${clubColor};"><a href="${cpath }/0?param=newOrder#thirdPage" style="color: #FFFFFF;"><h6>Date</h6></a></th>		
								</tr>
							</thead>
						</table>
					</div>
...
$.ajax({
	  ...
	  dataType: 'json',
		...
		for(let i = 0; i < matchday.matches.length; i++) { // 팀 고유 id를 받아와서 비교
			if(matchday.matches[i].homeTeam.id == 64 || matchday.matches[i].awayTeam.id == 64){
				matchday.matches[i].homeTeam.id == 64 ? isHome=true : isHome=false // 해당팀이 홈팀인지 어웨이팀인지 구분
