			...
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-110"">
						...
						<table>
							<thead>
								<tr class="row100 head" >
									<th class="cell100 column1" style="background:#162E59;"><button style="color: #FFFFFF;" id="newNumber" >최신</button></th>
									<th class="cell100 column2" style="background:#162E59;"><button style="color: #FFFFFF;" id="viewNumber" >조회수</button></th>
									<th class="cell100 column3" style="background:#162E59;"><button style="color: #FFFFFF;" id="likeNumber">추천수</button></th>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class= "sb" style="background:#162E59;">
							<form >
								<span >
								<select  name="type" style="background:#162E59;">
								...
								<span><input style="background:#162E59;" type="text" name="search" value="${param.search }" ></span>
                        		<span><input style="background:#162E59;" type="submit" value="검색"></span>
                    			 </form>
