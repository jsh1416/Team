			...
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-110"">
						...
						<table>
							<thead>
								<tr class="row100 head" >
									<th class="cell100 column1" style="background:#F00000;"><button style="color: #FFFFFF;" id="newNumber" >최신</button></th>
									<th class="cell100 column2" style="background:#F00000;"><button style="color: #FFFFFF;" id="viewNumber" >조회수</button></th>
									<th class="cell100 column3" style="background:#F00000;"><button style="color: #FFFFFF;" id="likeNumber">추천수</button></th>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class= "sb" style="background:#F00000;">
							<form >
								<span >
								<select  name="type" style="background:#F00000;">
								...
								<span><input style="background:#F00000;" type="text" name="search" value="${param.search }" ></span>
                        		<span><input style="background:#F00000;" type="submit" value="검색"></span>
                    			 </form>
