						...
						<table>
							<thead>
								<tr class="row100 head" >
									...
									<th class="cell100 column2" style="background:${clubColor};"><a href="${cpath }/3?param=viewOrder#thirdPage" style="color: #FFFFFF;"><h6>View</h6></a></th>
									<th class="cell100 column3" style="background:${clubColor};"><a href="${cpath }/3?param=likeOrder#thirdPage" style="color: #FFFFFF;"><h6>Like</h6></a></th>
									<th class="cell100 column3" style="background:${clubColor};"><button style="color: #FFFFFF;" id="writer"><h6>Writer</h6></button></th>
									<th class="cell100 column3" style="background:${clubColor};"><a href="${cpath }/3?param=newOrder#thirdPage" style="color: #FFFFFF;"><h6>Date</h6></a></th>		
								</tr>
							</thead>
						</table>
					</div>
